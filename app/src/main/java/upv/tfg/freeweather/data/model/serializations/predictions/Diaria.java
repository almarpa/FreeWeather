package upv.tfg.freeweather.data.model.serializations.predictions;


import java.io.Serializable;
import java.util.List;

import upv.tfg.freeweather.data.model.serializations.predictions.data_prediction.CotaNieveProv;
import upv.tfg.freeweather.data.model.serializations.predictions.data_prediction.EstadoCielo;
import upv.tfg.freeweather.data.model.serializations.predictions.data_prediction.HumedadRelativaDiaria;
import upv.tfg.freeweather.data.model.serializations.predictions.data_prediction.ProbPrecipitacionDiaria;
import upv.tfg.freeweather.data.model.serializations.predictions.data_prediction.RachaMax;
import upv.tfg.freeweather.data.model.serializations.predictions.data_prediction.SensTermicaDiaria;
import upv.tfg.freeweather.data.model.serializations.predictions.data_prediction.TemperaturaDiaria;
import upv.tfg.freeweather.data.model.serializations.predictions.data_prediction.Viento;
